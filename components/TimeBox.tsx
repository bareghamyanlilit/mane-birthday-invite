...
export function TimeBox() {
  ...
  return (
    <motion.section
      {...anim}
      className=" my-20  flex flex-col gap-5 text-center  text-vrayi  px-0 "
    >
            <motion.h2 {...anim} className=" leading-12 text-2xl mb-10 font-bold">
              Միջոցառմանը մնաց
            </motion.h2>
      <div className="">
        {timeLeft.finished ? (
          ...
          <motion.div {...anim} className="flex items-center justify-center text-5xl font-extralight ">
